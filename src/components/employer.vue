...
<template>
 ...
 <header>
      ...
      <ul class="menu">
        <li class=""><router-link to="/Rregister" class="resume_create">Зарегистрироваться</router-link></li>
        <li class=""><router-link to="/Rautoriz" class="entrance">Войти</router-link></li>
    </ul>
      <form>
        <h1 >Какие есть сотрудники </h1>
